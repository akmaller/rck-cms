...
export async function sendActivationEmail({
  ...
  const html = `
    <div style="font-family:Arial,sans-serif;line-height:1.6;color:#0f172a">
      <h2 style="color:#0f172a">Aktivasi Akun Roemah Cita</h2>
      <p>Halo ${name},</p>
      <p>Terima kasih telah mendaftar sebagai penulis di Roemah Cita. Klik tombol di bawah ini untuk mengaktifkan akun Anda.</p>
      ...
      <p style="color:#94a3b8;font-size:12px">Email ini dikirim otomatis oleh sistem Roemah Cita CMS. Jika Anda tidak merasa mendaftar, abaikan pesan ini.</p>
    </div>
  `;
  ...
  await sendMail({
    to: email,
    subject: "Aktivasi Akun Penulis Roemah Cita",
    html,
    text,
  });
}
